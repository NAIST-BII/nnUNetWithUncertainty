...
class nnUNetDataset(object):
    ...
    def __getitem__(self, key):
        ...
        print(f"Getting single item time in nnUNetDataset: \t\t{time() - st:0.3f} sec")
        return ret
    ...
    def load_case(self, key):
        ...
        # print(f"Open data file time: \t\t{time() - st:0.3f} sec")
        if 'open_seg_file' in entry.keys():
            ...
            # print(f"Open seg file time: \t\t{time() - st:0.3f} sec")
        ...
        if 'seg_from_prev_stage_file' in entry.keys():
            ...
            # print(f"Open seg from previous stage file time: \t\t{time() - st:0.3f} sec")
