...
class nnUNetPredictor(object):
    ...
    def predict_from_files(self,
        ...
        list_of_lists_or_source_folder, output_filename_truncated, seg_from_prev_stage_files = \
            self._manage_input_and_output_lists(list_of_lists_or_source_folder,
                                                ...
                                                save_probabilities, save_entropy)
        ...
        return self.predict_from_data_iterator(data_iterator, save_probabilities, save_entropy, num_processes_segmentation_export)
    ...
    def predict_from_list_of_npy_arrays(self,
        ...
        iterator = self.get_data_iterator_from_raw_npy_data(image_or_list_of_images,
                                                            ...
                                                            truncated_ofname,
                                                            num_processes)
        return self.predict_from_data_iterator(iterator, save_probabilities, save_entropy,num_processes_segmentation_export)
                    ...
                    r.append(
                        export_pool.starmap_async(
                            ...
                            ((prediction, properties, self.configuration_manager, self.plans_manager,
                              self.dataset_json, ofile, save_probabilities, save_entropy),)
                        )
                    )
                else:
    ...
    def predict_single_npy_array(self, input_image: np.ndarray, image_properties: dict,
                                 ...
                                 save_or_return_entropy: bool = False,
                                 ):
        """
        ...
        if output_file_truncated is not None:
            ...
            ret = convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits, self.plans_manager,
                                                                              ...
                                                                              return_entropy=
                                                                              save_or_return_entropy)
            if save_or_return_probabilities | save_or_return_entropy:
                if save_or_return_entropy:
...
def predict_entry_point_modelfolder():
    ...
    parser.add_argument('--save_entropy', action='store_true',
                        help='Set this to export entropy of the predicted class "entropy" as a measure of uncertainty. '
                             'multiple configurations.')
...
if __name__ == '__main__':
    ...
    ret = predictor.predict_from_data_iterator(iterator, False, False, 1)
